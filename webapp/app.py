...
#columna 1 
    with col1:
        ...
        customer_state = st.selectbox("Estado",
                                      BR_STATES,
                                      index=BR_STATES.index("SP"),
                                      help="Estado brasileño: SP (São Paulo), BA (Bahía), etc.")
        ...
        if city_options:
            ...
            customer_city = st.text_input("Ciudad",
                                          value="sao paulo",
                                          help="Ciudad del cliente. Ej: sao paulo")

        customer_zip_code_prefix = st.number_input("Código postal (prefijo)",
                                                   min_value=0,
                                                   value=10000,
                                                   step=1,
    ...
    with col3:
        ...
        geo_lat = st.number_input("Latitud",
                                  value=-23.55,
                                  step=0.01,
                                  format="%.6f",
                                  help="Coordenada aproximada del cliente (latitud).")
        geo_lng = st.number_input("Longitud",
                                  value=-46.63,
                                  step=0.01,
                                  format="%.6f",
                                  help="Coordenada aproximada del cliente (longitud).")
